...
This document outlines security procedures and general policies for the `swagger-editor-validate`
project.
...
The `swagger-editor-validate` team and community take all security bugs in `swagger-editor-validate` seriously.
Thank you for improving the security of `swagger-editor-validate`. We appreciate your efforts and
