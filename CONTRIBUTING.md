# Contributing to swagger-editor-validate
...
* In GitHub, send a pull request to `swagger-editor-validate:master`.
...
we use the git commit messages to **generate the swagger-editor-validate change log**.
...
Thank you to all the people who have already contributed to swagger-editor-validate!
